/**
 * Gridx Portfolio - Theme Controller
 * Modern color-scheme detection & persistence
 */

(function initTheme() {
  const STORAGE_KEY = 'yamid_portfolio_theme';
  ...
  // Initial setup
  const currentTheme = savedTheme || (prefersDark.matches ? 'dark' : 'dark'); // default dark for Gridx aesthetic
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.theme-toggle-btn').forEach(btn => {
      btn.addEventListener('click', window.togglePortfolioTheme);
    });
  });
})();
